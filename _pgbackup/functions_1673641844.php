...
if ( ! function_exists( 'mossco_hc_enqueue_scripts' ) ) :
    ...
    wp_enqueue_script( 'mossco_hc-pgia', get_template_directory_uri() . '/pgia/lib/pgia.js', [], '1.0.175', true);

    wp_deregister_script( 'mossco_hc-header' );
    wp_enqueue_script( 'mossco_hc-header', get_template_directory_uri() . '/assets/js/header.js', [], '1.0.175', true);

    wp_register_script( 'inline-script-1', '', [], '1.0.175', false );
    ...
    wp_enqueue_script( 'mossco_hc-maps', get_template_directory_uri() . '/assets/js/maps.js', [], '1.0.175', false);

    wp_deregister_script( 'mossco_hc-script' );
    wp_enqueue_script( 'mossco_hc-script', 'https://maps.googleapis.com/maps/api/js?key=AIzaSyDCjQbOAcZR002cGDTl_hchKl_Oo9vI33U&callback=initMap', [], '1.0.175', true);
    ...
    wp_enqueue_style( 'mossco_hc-tailwind', get_template_directory_uri() . '/tailwind_theme/tailwind.css', [], '1.0.175', 'all');

    wp_deregister_style( 'mossco_hc-custom' );
    wp_enqueue_style( 'mossco_hc-custom', get_template_directory_uri() . '/custom.css', [], '1.0.175', 'all');

    wp_deregister_style( 'mossco_hc-fancybox' );
    wp_enqueue_style( 'mossco_hc-fancybox', get_template_directory_uri() . '/assets/css/fancybox.css', [], '1.0.175', 'all');

    wp_deregister_style( 'mossco_hc-bgimages' );
    wp_enqueue_style( 'mossco_hc-bgimages', get_template_directory_uri() . '/assets/css/bg-images.css', [], '1.0.175', 'all');

    wp_deregister_style( 'mossco_hc-all' );
    wp_enqueue_style( 'mossco_hc-all', 'https://use.fontawesome.com/releases/v5.13.1/css/all.css', [], '1.0.175', 'all');

    wp_deregister_style( 'mossco_hc-style' );
    wp_enqueue_style( 'mossco_hc-style', get_bloginfo('stylesheet_url'), [], '1.0.175', 'all');
