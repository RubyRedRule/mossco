...
<main>
    <section id="day-banner" class="border-b-4 border-primary-NORMAL border-solid flex items-center justify-center">
        <div class="flex justify-center text-center text-gray-200 w-full">
            <h1 class="flex font-medium font-sans lowercase text-5xl text-center sm:text-6xl md:text-6xl lg:text-6xl xl:text-7xl 2xl:text-7xl"><?php _e( 'day menu', 'mossco_hc' ); ?></h1>
        </div>
    </section>
