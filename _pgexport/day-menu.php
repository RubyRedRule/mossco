...
<main>
    <section id="day-banner" class="-mt-28 border-b-4 border-primary-NORMAL border-solid flex items-center justify-center" data-pg-ia-scene='{"l":[{"t":"div","a":{"l":[{"t":"","l":[{"t":"set","p":0.5,"d":0,"l":{"autoAlpha":0,"y":"100%"},"e":"Power1.easeOut"},{"t":"tween","p":0.5,"d":0.5,"l":{"autoAlpha":1,"y":"0%"},"e":"Power1.easeOut"}]}]},"p":"time","rev":"true"}]}'>
        <div class="flex justify-center text-center text-gray-200 w-full" data-pg-ia-hide>
            <h1 class="flex font-medium font-sans lowercase text-5xl text-center translate-y-12 sm:text-6xl md:text-6xl lg:text-6xl xl:text-7xl 2xl:text-7xl"><?php _e( 'day menu', 'mossco_hc' ); ?></h1>
        </div>
    </section>
    <section id="mossco-menu-col" class="container flex flex-wrap font-sans max-w-screen-xl mx-auto px-4 py-14">
        <div class="gap-2 grid grid-cols-1 md:gap-10 md:grid-cols-2">
            <div class="col-span-1">
                <h3 class="text-3xl text-primary-NORMAL"><?php _e( 'Day Menu', 'mossco_hc' ); ?></h3>
                ...
                <div class="menu_item">
                    ...
                    <p class="price"><?php _e( '€7.50', 'mossco_hc' ); ?></p>
                </div>
                <div class="menu_item">
                ...
                <div class="menu_item">
                    ...
                    <p class="price"><?php _e( '€10.00', 'mossco_hc' ); ?></p>
                </div>
                <div class="menu_item">
                ...
                <div class="menu_item">
                    ...
                    <p class="allergen_info"><?php _e( '(2,10,11,4)', 'mossco_hc' ); ?></p>
                    <p class="price"><?php _e( '€14.00', 'mossco_hc' ); ?></p>
                </div>
                <div class="menu_item">
                ...
                <div class="menu_item">
                    ...
                    <p class="allergen_info"><?php _e( '(10,4)', 'mossco_hc' ); ?></p>
                    <p class="price"><?php _e( '€17.00', 'mossco_hc' ); ?></p>
                </div>
                <h4 class="border-b-2 border-primary-NORMAL border-solid font-sans mid my-6 pb-2 text-xl"><?php _e( 'Main Course', 'mossco_hc' ); ?></h4> 
                <div class="menu_item">
                    ...
                    <p class="allergen_info"><?php _e( '(2,10,11,4)', 'mossco_hc' ); ?></p>
                    <p class="price"><?php _e( '€16.00', 'mossco_hc' ); ?></p>
                </div>
                <div class="menu_item">
                    ...
                    <p class="allergen_info"><?php _e( '(1,2,10,4)', 'mossco_hc' ); ?></p>
                    <p class="price"><?php _e( '€19.00', 'mossco_hc' ); ?></p>
                </div>
                <div class="menu_item">
                    ...
                    <p class="allergen_info"><?php _e( '(10,4)', 'mossco_hc' ); ?></p>
                    <p class="price"><?php _e( '€22.00', 'mossco_hc' ); ?></p>
                </div>
                <div class="border-primary-NORMAL border-r-4 border-t-4 dark part2 pb-16 lg:pb-0 xl:pb-14 2xl:pb-12 rounded-xl md:my-0">
                    ...
                    <div class="menu_item">
                        ...
                        <p class="allergen_info"><?php _e( '(2,10,11,4)', 'mossco_hc' ); ?></p>
                        <p class="price"><?php _e( '€3.00', 'mossco_hc' ); ?></p>
                    </div>
                    <div class="menu_item">
                    ...
                    <div class="menu_item">
                        ...
                        <p class="allergen_info"><?php _e( '(10,4)', 'mossco_hc' ); ?></p>
                        <p class="price"><?php _e( '€2.50', 'mossco_hc' ); ?></p>
                    </div>
            ...
            <div class="col-span-1 mt-4 md:mt-4">
                ...
                <div class="menu_item">
                    ...
                    <p class="allergen_info"><?php _e( '(2,10,11,4)', 'mossco_hc' ); ?></p>
                    <p class="price"><?php _e( '€12.00', 'mossco_hc' ); ?></p>
                </div>
                <div class="menu_item">
                ...
                <div class="menu_item">
                    ...
                    <p class="allergen_info"><?php _e( '(10,4)', 'mossco_hc' ); ?></p>
                    <p class="price"><?php _e( '€15.00', 'mossco_hc' ); ?></p>
                </div>
                <div class="menu_item">
                ...
                <div class="menu_item">
                    ...
                    <p class="allergen_info"><?php _e( '(1,2,10,4)', 'mossco_hc' ); ?></p>
                    <p class="price"><?php _e( '€13.00', 'mossco_hc' ); ?></p>
                </div>
                <div class="menu_item">
                ...
                <div class="menu_item">
                    ...
                    <p class="price"><?php _e( '€2.00', 'mossco_hc' ); ?></p>
                </div>
                ...
                <div data-empty-placeholder class="day-menu-bg h-0 hidden md:flex md:h-1/5"></div>
            </div>
        </div>
    </section>
