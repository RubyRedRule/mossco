    ...
    <div class="-mt-28 container duration-500 h-24 max-w-screen-xl mossco-header mx-auto px-0 sticky top-1 transform transition z-50 md:top-0 lg:top-2"> 
        <nav class="flex flex-wrap items-center justify-between p-4 sm:py-5 md:px-4 lg:py-0"> <a href="index.html"><img src="<?php echo get_template_directory_uri(); ?>/assets/images/logo/logo-white-teal.svg" class="drop-shadow-xl duration-500 h-9 ml-4 mossco-logo mr-auto scale-125 transform transition lg:h-9"></a>
            ...
            <div class="bg-Mossco-grey-dark bg-opacity-95 hidden mx-auto pl-4 py-8 rounded space-y-2 text-center w-full md:max-w-md md:mr-0 lg:bg-opacity-0 lg:flex lg:max-w-full lg:space-x-4 lg:space-y-0 lg:text-left lg:w-auto" data-name="nav-menu" data-pg-ia-hide> 
                <div class="flex flex-col font-medium text-gray-50 lg:flex-row lg:text-sm"> <a href="cafe-menu.html" class="hover:text-primary-LIGHT px-0 py-2 uppercase lg:px-4"><?php _e( 'CAFÉ Menu', 'mossco_hc' ); ?></a> <a href="day-menu.html" class="hover:text-primary-LIGHT px-0 py-2 uppercase lg:px-4"><?php _e( 'Day Menu', 'mossco_hc' ); ?></a><a href="evening-menu.html" class="hover:text-primary-LIGHT px-0 py-2 uppercase lg:px-4"><?php _e( 'Evening Menu', 'mossco_hc' ); ?></a>
                    <a href="#details-map" class="hover:text-primary-LIGHT px-0 py-2 uppercase lg:px-4" target="#location-map"><?php _e( 'Location', 'mossco_hc' ); ?></a>
        ...
        <div class="gap-2 grid grid-cols-1 md:gap-10 md:grid-cols-2">
            ...
            <div class="col-span-1 mt-4 md:mt-4">
                ...
                <div class="menu_item">
                    ...
                    <dd>
                        <i><?php _e( '- Grilled Garlic, lemon &amp; tarragon chicken skewers', 'mossco_hc' ); ?></i>
                    </dd>
                    <dd>
                        <i><?php _e( '- Grilled garlic &amp; chili black tiger prawn skewers', 'mossco_hc' ); ?></i>
                    </dd>
                    <dd>
                        <i><?php _e( '- Smoky BBQ glazed haloumi skewers', 'mossco_hc' ); ?></i>
                    </dd>
